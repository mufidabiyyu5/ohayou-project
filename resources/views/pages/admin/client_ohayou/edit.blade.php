    ...
    <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Foto Klien</h1>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="{{route('client.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Contoh: SMAN 6 Kabupaten Tangerang, Mayora" value="{{$item->name}}">
                                </div>
                                <div class="form-group">
