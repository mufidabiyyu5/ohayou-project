                        ...
                        <div class="card-body">
                            <form action="{{route('testimonial.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customer" placeholder="Contoh: Bambang" value="{{old('customer')}}">
                                </div>
                                <div class="form-group">
                                    <label for="about_customer">Bio Customer</label>
                                    <input type="text" class="form-control" name="about_customer" placeholder="Contoh: Pembeli di Shopee" value="{{old('about_customer')}}">
                                </div>
                                <div class="form-group">
